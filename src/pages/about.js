...
const AboutPage = () => {
  return (
    <Layout>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ✅&#160;<s>Stand as a speaker at <a rel="noopener noreferrer" href="https://2022.pycon.kr/" target="_blank">PyCon Korea</a> / 2022</s>
            </li>
            <li>
      ...
      <ul>
        <li>
          Modern C, Modern C++, C#, Python, Rust, JavaScript, HTML, <p style={{ display: 'inline', color: 'lightgrey' }}>
